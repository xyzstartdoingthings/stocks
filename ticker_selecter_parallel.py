...
# change
ticker_range = range(917, 927)
a = int(len(ticker_range)/6)
variables = {"atr_len": np.arange(11, 12, 1), "macd_fastLen": np.arange(11, 12, 1), "macd_slowLen": np.arange(32, 34, 2), "macd_signalSmooth": np.arange(
    7, 8, 1), "macd_peakLen": [3, 5], "gain_ratio": np.arange(1, 2, 1), "loss_ratio": np.arange(1, 2, 1), "peak2_len": [20], "peak3_len": [40]}
